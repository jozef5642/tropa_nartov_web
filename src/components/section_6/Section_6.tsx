            ...
            <div className={styles.background_pattern}>
                ...
                <div className={styles.circle_lines}>
                    <svg className={styles.circle_svg} viewBox="0 0 800 800">
                        <circle cx="400" cy="400" r="150" fill="none" stroke="#E5E5E5" strokeWidth="1" strokeDasharray="5,5" />
                        <circle cx="400" cy="400" r="250" fill="none" stroke="#E5E5E5" strokeWidth="1" strokeDasharray="5,5" />
                        <circle cx="400" cy="400" r="350" fill="none" stroke="#E5E5E5" strokeWidth="1" strokeDasharray="5,5" />
                    </svg>
                </div>
